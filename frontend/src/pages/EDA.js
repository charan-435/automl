...
const ChartTooltip = ({ active, payload, label }) => {
  ...
  return (
    <div style={{
      ...
      borderRadius: 2, padding: "8px 14px", fontFamily: "'DM Mono',monospace", fontSize: 11,
    }}>
...
export default function EDA() {
  ...
  useEffect(() => {
    axios.get(`${API}/eda`)
      ...
      .catch(err => { console.error(err); setError("Failed to load EDA data."); });
  }, []);
  ...
  // Summary stat keys in preferred order
      ...
      <div className="eda-root">
        <div className="eda-inner">
          ...
          <div className="page-header">
            ...
            <h1 className="page-title">EDA <span>Dashboard</span></h1>
          </div>
          ...
          <div className="section" style={{ animationDelay: "0.05s" }}>
            ...
            <div className="pill-row">
              {data.columns.map(col => (
                <div className="col-pill" key={col}>{col}</div>
              ))}
            </div>
          </div>
          ...
          {/* ── Histograms ── */}
          {data.histograms && Object.keys(data.histograms).length > 0 && (
            <div className="section" style={{ animationDelay: "0.11s" }}>
                  ...
                  <div className="chart-card" key={col}>
                    ...
                    <div className="chart-card-body">
                      <div className="chart-col-name">
                        <div className="chart-col-dot" />{col}
                      </div>
          ...
          {data.categorical && Object.keys(data.categorical).length > 0 && (
            <div className="section" style={{ animationDelay: "0.14s" }}>
                ...
                {Object.entries(data.categorical).map(([col, values]) => {
                  ...
                  return (
                    <div className="chart-card" key={col}>
                      ...
                      <div className="chart-card-body">
                        <div className="chart-col-name">
                          <div className="chart-col-dot violet" />{col}
                        </div>
                        <ResponsiveContainer width="100%" height={220}>
                          <PieChart>
                            ...
                            <Legend iconType="circle" iconSize={7}
                              formatter={(val) => <span style={{ color: TEXT_DIM, fontFamily: "'DM Mono'", fontSize: 10 }}>{val}</span>} />
                          </PieChart>
                        </ResponsiveContainer>
                      </div>
                    </div>
          ...
          {data.importance && Object.keys(data.importance).length > 0 && (
            <div className="section" style={{ animationDelay: "0.20s" }}>
                  ...
                  <ResponsiveContainer width="100%" height={260}>
                    ...
                    >
                      ...
                      <YAxis type="category" dataKey="name" width={120}
                        tick={{ fill: TEXT_DIM, fontSize: 10, fontFamily: "'DM Mono'" }} axisLine={false} tickLine={false} />
          ...
          {/* ── Missing values ── */}
          <div className="section" style={{ animationDelay: "0.23s" }}>
          ...
          {data.summary && summaryColNames.length > 0 && (
            <div className="section" style={{ animationDelay: "0.26s" }}>
